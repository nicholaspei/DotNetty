...
namespace DotNetty.Codecs.Http.Tests
{
    ...
    public sealed class HttpContentCompressorTest
    {
        ...
        public void FullContent()
        {
            ...
            var res = new DefaultFullHttpResponse(HttpVersion.Http11, HttpResponseStatus.OK, Unpooled.CopiedBuffer(Encoding.ASCII.GetBytes("Hello, World")));
            res.Headers.Set(HttpHeaderNames.ContentLength, res.Content.ReadableBytes);
            ch.WriteOutbound(res);
