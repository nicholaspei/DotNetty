...
namespace DotNetty.Codecs.Http.Tests
{
    ...
    public sealed class HttpResponseDecoderTest
    {
        ...
        public void LastResponseWithTrailingHeader()
        {
            ...
            IList<ICharSequence> values = headers.GetAll((StringCharSequence)"Set-Cookie");
            Assert.Equal(2, values.Count);
            Assert.True(values.Contains((StringCharSequence)"t1=t1v1"));
            Assert.True(values.Contains((StringCharSequence)"t2=t2v2; Expires=Wed, 09-Jun-2021 10:18:14 GMT"));
            lastContent.Release();
