...
namespace DotNetty.Microbench.Http
{
    ...
    public sealed class HttpRequestDecoderTests
    {
        const int ContentLength = 120;
        readonly int[] steps = { 2, 4, 8, 16, 32 };
        ...
        readonly byte[] contentMixedDelimiters;
        readonly ITestOutputHelper output;

        public HttpRequestDecoderTests(ITestOutputHelper output)
        {
            this.output = output;
        ...
        public void DecodeWholeRequestInMultipleStepsMixedDelimiters()
        {
            ...
            {
                CodeTimer.Time(true, this.output, $"HttpRequestDecoder decode full request in {step} steps", 1000, 
                    () => DecodeWholeRequestInMultipleSteps(this.contentMixedDelimiters, step));
            }
        }
