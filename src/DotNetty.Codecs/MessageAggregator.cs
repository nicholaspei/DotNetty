...
namespace DotNetty.Codecs
{
    ...
    /// <summary>
    /// An abstract <see cref="IChannelHandler" /> that aggregates a series of message objects 
        ...
        protected internal override void Decode(IChannelHandlerContext context, TMessage message, List<object> output)
        {
            if (this.IsStartMessage(message))
            {
                ...
                if (continueResponse != null)
                {
                    ...
                    context.WriteAndFlushAsync(continueResponse);
                ...
                var provider = m as IDecoderResultProvider;
                if (provider != null && !provider.Result.IsSuccess)
                {
                    TOutput aggregated;
                    var holder = m as IByteBufferHolder;
                    if (holder != null && holder.Content.IsReadable())
                    {
                ...
                var bufferHolder = m as IByteBufferHolder;
            ...
            else if (this.IsContentMessage(message))
            {
                ...
                if (provider != null)
                {
                    ...
                    {
                        var resultProvider = this.currentMessage as IDecoderResultProvider;
