...
namespace DotNetty.Common.Utilities
{
    ...
    public static class CharUtil
    {
        ...
        static readonly char MinHighSurrogate = '\uD800';
        static readonly char MaxHighSurrogate = '\uDBFF';
        static readonly char MinLowSurrogate = '\uDC00';
        static readonly char MaxLowSurrogate = '\uDFFF';

        static readonly string DigitKeys = "0Aa\u0660\u06f0\u0966\u09e6\u0a66\u0ae6\u0b66\u0be7\u0c66\u0ce6\u0d66\u0e50\u0ed0\u0f20\u1040\u1369\u17e0\u1810\uff10\uff21\uff41";
        ...
        static int IndexOfFirstNonWhiteSpace(IReadOnlyList<char> value, int length)
        {
            int i = 0;
        ...
        static int IndexOfLastNonWhiteSpaceChar(IReadOnlyList<char> value, int start, int length)
        {
            int i = length - 1;
