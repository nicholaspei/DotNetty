...
namespace DotNetty.Codecs.Http
{
    ...
    public class HttpClientUpgradeHandler : HttpObjectAggregator
    {
        ...
        public override Task WriteAsync(IChannelHandlerContext context, object message)
        {
            ...
            {
                throw new InvalidOperationException("Attempting to write HTTP request with upgrade in progress");
            }
        ...
        protected override void Decode(IChannelHandlerContext context, IHttpObject message, List<object> output)
        {
            ...
            try
            {
                ...
                if (message is IHttpResponse)
                {
                    var rep = (IHttpResponse)message;
                ...
                if (message is IFullHttpResponse)
                {
                    response = (IFullHttpResponse)message;
                ...
                if (upgradeHeader != null 
                    && !AsciiString.ContentEqualsIgnoreCase(this.upgradeCodec.Protocol, upgradeHeader))
                {
        ...
        void SetUpgradeRequestHeaders(IChannelHandlerContext ctx, IHttpRequest request)
        {
            ...
            var connectionParts = new List<ICharSequence>();
