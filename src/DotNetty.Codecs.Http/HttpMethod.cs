...
namespace DotNetty.Codecs.Http
{
    ...
    public sealed class HttpMethod : IComparable<HttpMethod>, IComparable
    {
        ...
        static readonly IReadOnlyDictionary<string, HttpMethod> MethodMap;

        static HttpMethod()
        {
            var methods = new Dictionary<string, HttpMethod>
            {
            ...
            MethodMap = new ReadOnlyDictionary<string, HttpMethod>(methods);
        }

        public static HttpMethod ValueOf(string name) => 
            MethodMap.TryGetValue(name, out HttpMethod result) ? result : new HttpMethod(name);
