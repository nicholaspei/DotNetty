...
namespace DotNetty.Codecs.Http
{
    ...
    {
        static readonly AsciiString GZipString = new AsciiString("gzip");
        static readonly AsciiString DeflateString = new AsciiString("deflate");
        ...
        protected override Result BeginEncode(IHttpResponse headers, ICharSequence acceptEncoding)
        {
            ...
            return new Result(targetContentEncoding,
              new EmbeddedChannel(
                  ...
                  ZlibCodecFactory.NewZlibEncoder(wrapper.Value, this.compressionLevel, this.windowBits, this.memLevel)));
        }
